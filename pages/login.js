    ...
    <>
      ...
      <main className={styles.authContainer}>
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          {messageAPI && (
            <div
              className={`${styles.message} ${styles.messageAPI} ${
                messageType === "error" && styles.onError
              }  ${messageType === "success" && styles.onSuccessServer}`}
            >
              <svg
                className={styles.icon}
                width="20"
          ...
          {loginOpt === "signin" ? (
            <>
              <Link href="/forgotten-password">
                <span className={styles.forgotten}>Mot de passe oublié?</span>
              </Link>
              <button>Se connecter</button>

              <div className={styles.register}>
                <span>Pas encore de compte?</span>
                <span onClick={onClick} className={styles.signUp}>
                  Inscrivez-vous
                </span>
              </div>
            </>
