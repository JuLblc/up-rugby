...
const Footer = () => {
  return (
    <footer>
        <div>
          "A force de vadrouiller dans le rugby, je suis passé par de nombreux
          clubs (à cause de ma grande bouche !) et de nombreux postes !
          Passionné par le rugby depuis un peu plus de 15 ans maintenant j'aime
          partager mes compétences et mes analyses!"
        </div>
        <div>
          <div className='footer-title'>Contactez-moi</div>
          ...
          <div className='footer-title'>Suivez-moi</div>
