        ...
        <div>
          ...
          <p>
            <i>
              ...
              maintenant j'aime partager mes compétences et mes analyses! Mon
              contenu s'adresse à tous les amoureux de ce magnifique sport. "
            </i>
          </p>
        </div>
        <div>
          ...
          <div className={styles.footerSocial}>
            ...
            {/* Facebook */}
            <a
              href="https://www.facebook.com/uprugby"
              target="_blank"
              rel="noreferrer"
            >
            ...
            {/* Youtube */}
            <a
              href="https://www.youtube.com/c/uprugby"
              target="_blank"
              rel="noreferrer"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            {/* Linkedin */}
            <a
              href="https://www.linkedin.com/in/charles-jouan-34963255/"
              target="_blank"
              rel="noreferrer"
            >
              <svg
